...
public class Hook {
  ...
  public enum Item implements ItemStackValue {
    ...
    HOOK_SHOT(ItemUtils.Create.createItem(Material.ARROW, ChatColor.WHITE + "Hook Shot", List.of(
            Text.Label.ACTION.asColor() + "Load Hook",
            Text.Label.TIP.asColor() + "[Off-Hand + Reload Crossbow]",
            Text.Label.DETAILS.asColor() + "Modifies the next crossbow shot",
            Text.Label.DETAILS.asColor() + "to launch the user forward on impact.",
    ...
    HOOK_GEAR(ItemUtils.Create.createItem(Material.LEATHER_LEGGINGS, ChatColor.WHITE + "H.O.O.K Gear", List.of(
            Text.Label.ACTION.asColor() + "Propel",
            Text.Label.TIP.asColor() + "[Empty Off-Hand + Sneak-Interact]",
            Text.Label.DETAILS.asColor() + "Fires a projectile that",
            Text.Label.DETAILS.asColor() + "launches the user forward on impact.",
